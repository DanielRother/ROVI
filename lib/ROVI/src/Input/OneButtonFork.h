// This fork is based on https://github.com/mathertel/OneButton but changes the callback method
// type to std::function<void(void)> making this class easier to use
...
#ifndef OneButtonFork_h
#define OneButtonFork_h
