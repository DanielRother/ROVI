...
//     mqtt.addOnConnectCallback(std::bind(&SomeMqttTestClass::onMqttConnect,
//     this,
//                                         std::placeholders::_1));
...
//     mqtt.addOnPublishCallback(std::bind(&SomeMqttTestClass::onMqttPublish,
//     this,
//                                         std::placeholders::_1));
//   };
...
//     std::cout << "Subscribing at QoS 2, packetId: " << packetIdSub <<
//     std::endl; mqtt.publish("test/lol", Rovi::Common::MqttQoS::AT_MOST_ONCE,
//     true,
//                  "test 1");
...
//     std::cout << "Publishing at QoS 1, packetId: " << packetIdPub1 <<
//     std::endl; uint16_t packetIdPub2 = mqtt.publish(
//         "test/lol", Rovi::Common::MqttQoS::EXCACTLY_ONCE, true, "test 3");
//     std::cout << "Publishing at QoS 2, packetId: " << packetIdPub2 <<
//     std::endl;
//   }
